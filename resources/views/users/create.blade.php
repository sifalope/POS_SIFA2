...
<style>
    ...
    .card-create-user input[type="text"],
    .card-create-user input[type="email"],
    .card-create-user input[type="password"],
    .card-create-user select {
    ...
    .card-create-user input:focus,
    .card-create-user select:focus {
    ...
    .card-create-user .btn-simpan,
    .card-create-user button[type="submit"] {
    ...
    .card-create-user .btn-simpan:hover,
    .card-create-user button[type="submit"]:hover {
    ...
    .card-create-user .btn-kembali,
    .card-create-user a.btn {
    ...
    .card-create-user .btn-kembali:hover,
    .card-create-user a.btn:hover {
